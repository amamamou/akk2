...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentView === "login") {
      ...
      // Registration not yet implemented on backend
      // For now, show message
      alert("Registration via frontend coming soon. Please contact support.")
    } else if (currentView === "forgot") {
      // Password reset not yet implemented on backend
          ...
          <p className="text-sm text-muted-foreground text-center mb-6">
           ...
           <div className="space-y-4">
             {currentView === "register" && (
               <div className="space-y-2">
                 ...
                 <Input id="name" type="text" placeholder="John Doe" value={formData.name} onChange={handleInputChange} className="h-12 border border-gray-200 rounded-lg bg-white px-3 focus:outline-none focus:ring-2 focus:ring-[#A473FF]" />
               </div>
             )}

             <div className="space-y-2">
               <Label htmlFor="email" className="text-sm font-medium text-foreground">Email</Label>
               <Input id="email" type="email" placeholder="user@company.com" value={formData.email} onChange={handleInputChange} className="h-12 border border-gray-200 rounded-lg bg-white px-3 focus:outline-none focus:ring-2 focus:ring-[#A473FF]" />
             </div>
             ...
             {currentView !== "forgot" && (
               <div className="space-y-2">
                 ...
                 <div className="relative">
                   <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter password" value={formData.password} onChange={handleInputChange} className="h-12 pr-10 border border-gray-200 rounded-lg bg-white px-3 focus:outline-none focus:ring-2 focus:ring-[#A473FF]" />
             ...
             {currentView === "register" && (
               <div className="space-y-2">
                 ...
                 <div className="relative">
                   <Input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} placeholder="Confirm password" value={formData.confirmPassword} onChange={handleInputChange} className="h-12 pr-10 border border-gray-200 rounded-lg bg-white px-3 focus:outline-none focus:ring-2 focus:ring-[#A473FF]" />
           ...
           <div className="mt-4">
             <Button
               ...
               disabled={isLoading}
               className="w-full h-12 text-sm font-medium text-white hover:opacity-90 rounded-lg shadow-none flex items-center justify-center gap-2"
             ...
             {currentView !== "forgot" && (
               <>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                   <Button variant="outline" className="h-12 border-gray-200 hover:bg-gray-50 hover:text-gray-900 rounded-lg bg-white shadow-none" disabled>
             ...
             {currentView === "login" && (
               <div className="mt-6 text-center text-sm text-muted-foreground">
                 ...
                 <Button
                   variant="link"
                   className="p-0 h-auto text-sm hover:text-opacity-80"
                   style={{ color: "#A473FF" }}
