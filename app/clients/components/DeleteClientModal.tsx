      ...
      >
        <header className="flex items-start justify-between gap-4 border-b border-gray-100 px-6 py-5 dark:border-zinc-700/60">
          <div className="min-w-0">
            ...
            <h2 id="delete-client-title" className={cn(dashboardPanelTitle, "text-lg")}>
              Delete client
            </h2>
            <p className={cn(dashboardPanelSubtitle, "mt-1")}>
              This action cannot be undone. All workspace data for this client will be removed.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="px-6 py-5">
          <p className={dashboardSectionLabel}>Client to delete</p>
          <div
            className={cn(
              dashboardCardClass,
          ...
          >
            <p className="font-medium text-gray-900 dark:text-zinc-100">{client.name}</p>
            {client.businessType ? (
              <p className="mt-1 text-sm text-gray-500 dark:text-zinc-400">{client.businessType}</p>
            ) : null}
          </div>
        </div>
        ...
        <ModalFooterActions
          ...
          onPrimary={() => void onConfirm(client.id)}
