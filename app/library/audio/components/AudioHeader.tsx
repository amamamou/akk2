...
export default function AudioHeader({
  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-zinc-900 border-b border-gray-100 dark:border-zinc-800/40">
      <div className="sticky top-0 z-10 bg-white dark:bg-zinc-900">
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100">All Audio</h1>
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <button
                  ...
                  className="group inline-flex items-center gap-2 h-12 px-4 bg-white dark:bg-zinc-800 text-gray-700 dark:text-zinc-200 text-sm font-medium rounded-2xl border border-gray-100 dark:border-zinc-700 shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-none transition-all hover:shadow-lg hover:translate-y-0.5 cursor-pointer"
                >
                  <span className="inline-flex items-center justify-center transition-colors">
                    <List size={16} className="text-zinc-500 dark:text-zinc-400 group-hover:text-[#A473FF] transition-colors" />
                  </span>
                  <span className="hidden sm:inline">Columns</span>
                </button>

                {colsOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-md shadow-lg p-3 z-50">
                    <div className="flex flex-col gap-2 text-sm text-gray-700 dark:text-zinc-200">
              ...
              >
                <span className="inline-flex items-center justify-center transition-colors">
                  <Plus size={16} strokeWidth={1.9} className="text-zinc-500 dark:text-zinc-400 group-hover:text-[#A473FF] transition-colors" />
                </span>
