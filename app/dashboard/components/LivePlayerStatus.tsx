	...
	return (
		<div className="bg-white border border-gray-200 rounded-lg shadow-sm">
			...
			<div className="p-4 space-y-3">
				{players.length === 0 && (
					<p className="text-sm text-gray-500">No players yet. Create your first player from the Players page to see its live status here.</p>
				)}
				{players.map((player) => (
					<div key={player.player} className="flex items-center gap-4 p-3 rounded-md hover:bg-gray-50 transition-colors">
